...
*/	
 ...
 /* uint16_t baseVoltage = base + inc;
  ...
  if (Voltage >= 2160)
    ...
    display.drawInvertedBitmap(274, 8, bat3icons, 17, 8, GxEPD_BLACK);   //GxEPD_BLACK);
  else if ((Voltage < 2100) && (Voltage >= 2000))
    display.drawInvertedBitmap(274, 8, bat2icons, 17, 8, GxEPD_BLACK);   //GxEPD_BLACK);
...
//****************************************************************************************************************************
  ...
  if( recordState==STATE_RECORD) {
      ...
      display.drawInvertedBitmap(posX, 5,fix1icons,  16, 16, GxEPD_BLACK);   //GxEPD_BLACK);
  } else  {
      display.drawInvertedBitmap(posX, 5,fix2icons,  16, 16, GxEPD_BLACK);   //GxEPD_BLACK);
  }
}
