...
#include <varioscreenIcone_291.h>
...
//			
			...
			display.drawInvertedBitmap(titleX+2, titleY-11, variotext, 27, 9, GxEPD_BLACK);
			break;
		case DISPLAY_OBJECT_RATIO :
//			
...
//			display.drawInvertedBitmap(titleX, titleY-8, heighttext, 32, 14, GxEPD_BLACK);
   			display.fillRect(titleX-70, titleY-6, 22, 9, GxEPD_WHITE);
			display.drawInvertedBitmap(titleX-67, titleY-6, agltext, 22, 9, GxEPD_BLACK);
			break;
		case DISPLAY_OBJECT_BEARING :
//			
...
//****************************************************************************************************************************
  ...
  display.setCursor(posX, posY);
  display.print('C'); 
//  display.drawInvertedBitmap(posX+160, posY-20, temp, 21, 17, GxEPD_BLACK);
//  display.drawInvertedBitmap(posX+10, posY-35, thermo, 48, 48, GxEPD_BLACK);
}
...
*/	
 ...
 /* uint16_t baseVoltage = base + inc;
  ...
  if (Voltage >= 2160)
    ...
    display.drawInvertedBitmap(110, 8, bat3icons, 17, 8, GxEPD_BLACK);   //GxEPD_BLACK);
  else if ((Voltage < 2100) && (Voltage >= 2000))
    display.drawInvertedBitmap(110, 8, bat2icons, 17, 8, GxEPD_BLACK);   //GxEPD_BLACK);
...
//****************************************************************************************************************************
  ...
  display.fillRect(posX+floor((float)satelliteBar*6.5), posY, 24-floor((float)satelliteBar*4.5), 24, GxEPD_WHITE);
...
//****************************************************************************************************************************
  ...
  if( recordState==STATE_RECORD) {
      ...
      display.drawInvertedBitmap(posX+5, 5,fix1icons,  16, 16, GxEPD_BLACK);   //GxEPD_BLACK);
  } else  {
      display.drawInvertedBitmap(posX+5, 5,fix2icons,  16, 16, GxEPD_BLACK);   //GxEPD_BLACK);
  }
}
...
// 'usb-24, 24x24px
	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xbd, 0xff, 0xff, 0xbd, 0xff, 0xff, 0xbd, 0xff, 0xff, 
	0xbd, 0xff, 0xff, 0xbd, 0xff, 0xff, 0x00, 0xff, 0xff, 0x7e, 0xff, 0xff, 0x7e, 0xff, 0xff, 0x7e, 
	0xff, 0xff, 0x7e, 0xff, 0xff, 0x7e, 0xff, 0xff, 0x7e, 0xff, 0xff, 0x7e, 0xff, 0xff, 0x7e, 0xff, 
	0xff, 0x00, 0xff, 0xff, 0xc3, 0xff, 0xff, 0xe7, 0xff, 0xff, 0xe7, 0xff, 0xff, 0xe7, 0xff, 0xff, 
